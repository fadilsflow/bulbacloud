        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {ServicesProducts.map((service) => (
            <Link key={service.id} href={`/layanan/${service.id}`} passHref>
              <Card className="group relative rounded-tr-2xl rounded-tl-none rounded-br-none rounded-bl-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 border border-primary/70">
                {/* Gradient Background */}
