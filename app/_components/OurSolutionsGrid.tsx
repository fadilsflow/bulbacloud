...
function ServiceCard({ service }: ServiceCardProps) {
  return (
    <Link href={service.href} passHref>
      <Card className="min-w-[80%] sm:min-w-0 group relative  overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300 h-full bg-primary/10  backdrop-blur-lg">
        {/* Gradient Background */}
